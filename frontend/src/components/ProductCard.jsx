  ...
  return (
    <>
      ...
      <ul className={styles.measurementsList}>
        <li>
          <span>Ring Size :</span> <span>{specs?.size || "—"}</span>
        </li>
        <li>
          <span>Metal :</span> <span>{specs?.metal || "—"}</span>
        </li>
        <li>
          <span>Stone :</span> <span>{specs?.stone || "—"}</span>
        </li>
        <li>
          <span>Total Weight :</span> <span>{specs?.weight || "—"}</span>
        </li>
      </ul>
